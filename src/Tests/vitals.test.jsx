...
//         // Ensure that Web Vitals functions are called with sendToAnalytics
//         const mockSendToAnalytics = jest.fn();

//         // Import the vitals file dynamically to invoke the metric listeners
//         jest.isolateModules(() => {
//             require('../vitals');
//         });
...
//         // Get the sendToAnalytics function from the module
//         const sendToAnalytics = (await import('../vitals')).default;
